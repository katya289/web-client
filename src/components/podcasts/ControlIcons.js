...
export default function ControlIcons({ playandpause, playing, rewind, fastForward, played, onSeek, onSeekMouseUp, playedTime, fullMovieTime, muting, muted, volume, volumeChange, volumeSeek, playRate, playerbackRate, fullScreenMode }) {
    ...
    return (
        <div className="controls__div">
            ...
            >
                ...
                <Grid item xs={12}>
                    <PrettoSlider min={0}
                        max={100} onChange={onSeek} onChangeCommitted={onSeekMouseUp}
                        value={played * 100} />
